...
#define GPIO_GPA04		S5PV210_GPA0(4) //NC
//#define GPIO_GPS_UART_RXD_AF		2

#define GPIO_GPA05		S5PV210_GPA0(5) //NC
//#define GPIO_GPS_UART_TXD_AF		2

#define GPIO_GPA06		S5PV210_GPA0(6) //NC
//#define GPIO_GPS_UART_CTS_AF		2

#define GPIO_GPA07		S5PV210_GPA0(7) //NC
...
#define GPIO_GPG36			S5PV210_GPG3(6)		//S8500 Correct,NC
...
#define GPIO_PHONE_ACTIVE_AF		2 //?? (from Oleg's comments, probably this value is good)
...
#define GPIO_GPJ30			S5PV210_GPJ3(0)		//I9000 _3_TOUCH_SDA_28V
#define GPIO_GPJ31			S5PV210_GPJ3(1)		//I9000 _3_TOUCH_SCL_28V
...
#define GPIO_MP045			S5PV210_MP04(5) //S8500 NC,maybe S8530 - GPIO_LVDS_RST

#define GPIO_FLM_SEL  			S5PV210_MP04(6)		//S8500 Correct!

#define GPIO_MP047			S5PV210_MP04(7)		//S8500 NC

#define GPIO_MP050			S5PV210_MP05(0)		//S8500 Correct NC

#define GPIO_DISPLAY_CS                 S5PV210_MP05(1)		//S8500 Correct,Thanks Mijoma)
